...
export type EnvironmentColor<T extends string = string> = {
    readonly [csl in T]: ColorScheme;
};

export const colorScheme: EnvironmentColor<ColorSchemeList> = {
    'Default Custom': {
...
export const myCustomColor: EnvironmentColor = {
    ...
    VENTEN: {
        _colorLeft: { r: 0.8125, g: 0.625, b: 0.375 },
        _colorRight: { r: 0.625, g: 0.375, b: 0.875 },
        _envColorLeft: { r: 0.78125, g: 0.625, b: 0.1875 },
        _envColorRight: { r: 0.09375, g: 0.4375, b: 0.6875 },
        _envColorLeftBoost: { r: 0.875, g: 0.0625, b: 0.375 },
        _envColorRightBoost: { r: 0.1875, g: 0.5, b: 0.875 },
        _obstacleColor: { r: 0.125, g: 0.25, b: 0.4375 },
    },
    'Unconscious Requiem': {
