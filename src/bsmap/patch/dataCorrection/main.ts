...
function fixRotationEvent(obj: IWrapRotationEventAttribute): void {
   ...
   obj.executionTime = fixInt(obj.executionTime, RotationEvent.defaultValue.executionTime, [0, 1]);
...
function fixColorNote(obj: IWrapColorNoteAttribute): void {
   ...
   obj.angleOffset = fixInt(obj.angleOffset, ColorNote.defaultValue.angleOffset);
...
function fixSlider(obj: IWrapArcAttribute): void {
   ...
   obj.lengthMultiplier = fixFloat(obj.lengthMultiplier, Arc.defaultValue.lengthMultiplier);
   ...
   obj.tailDirection = fixInt(obj.tailDirection, Arc.defaultValue.tailDirection);
...
function fixBasicEvent(obj: IWrapEventAttribute): void {
   ...
   obj.floatValue = fixFloat(obj.floatValue, BasicEvent.defaultValue.floatValue);
...
function fixIndexFilter(obj: IWrapIndexFilterAttribute): void {
   ...
   obj.random = fixInt(obj.random, IndexFilter.defaultValue.random, [0, 1, 2, 3]);
...
function fixLightColorEvent(obj: IWrapLightColorEventAttribute): void {
   ...
   obj.frequency = fixInt(obj.frequency, LightColorEvent.defaultValue.frequency);
   obj.color =
      obj.previous === 1
         ? fixInt(obj.color, -1, [-1, 0, 1, 2])
         : fixInt(obj.color, LightColorEvent.defaultValue.color, [0, 1, 2]);
   obj.easing = fixInt(obj.easing, LightColorEvent.defaultValue.easing, [0, 1, 2]);
   obj.previous = fixInt(obj.previous, LightColorEvent.defaultValue.previous, [0, 1]);
   obj.brightness = fixFloat(obj.brightness, LightColorEvent.defaultValue.brightness);
   obj.strobeBrightness = fixFloat(
      obj.strobeBrightness,
      LightColorEvent.defaultValue.strobeBrightness,
   );
   obj.strobeFade = fixInt(obj.strobeFade, LightColorEvent.defaultValue.strobeFade, [0, 1]);
}
...
function fixLightColorEventBoxGroup(obj: IWrapLightColorEventBoxGroupAttribute): void {
...
function fixLightRotationEvent(obj: IWrapLightRotationEventAttribute): void {
   ...
   obj.direction = fixInt(obj.direction, LightRotationEvent.defaultValue.direction, [0, 1, 2]);
   obj.previous = fixInt(obj.previous, LightRotationEvent.defaultValue.previous, [0, 1]);
   obj.rotation = fixFloat(obj.rotation, LightRotationEvent.defaultValue.rotation);
}

function fixLightRotationEventBox(obj: IWrapLightRotationEventBoxAttribute): void {
   fixIndexFilter(obj.filter);
   obj.beatDistribution = fixFloat(
      obj.beatDistribution,
   ...
   obj.axis = fixInt(obj.axis, LightRotationEventBox.defaultValue.axis, [0, 1, 2]);
...
function fixLightRotationEventBoxGroup(obj: IWrapLightRotationEventBoxGroupAttribute): void {
...
function fixLightTranslationEvent(obj: IWrapLightTranslationEventAttribute): void {
   ...
   obj.previous = fixInt(obj.previous, LightTranslationEvent.defaultValue.previous, [0, 1]);
   obj.translation = fixFloat(obj.translation, LightTranslationEvent.defaultValue.translation);
}

function fixLightTranslationEventBox(obj: IWrapLightTranslationEventBoxAttribute): void {
   fixIndexFilter(obj.filter);
   obj.beatDistribution = fixFloat(
      obj.beatDistribution,
   ...
   obj.axis = fixInt(obj.axis, LightTranslationEventBox.defaultValue.axis, [0, 1, 2]);
...
function fixLightTranslationEventBoxGroup(obj: IWrapLightTranslationEventBoxGroupAttribute): void {
   obj.time = fixFloat(obj.time, LightTranslationEventBoxGroup.defaultValue.time);
...
function fixFxEventBox(obj: IWrapFxEventBoxAttribute): void {
   fixIndexFilter(obj.filter);
   obj.beatDistribution = fixFloat(obj.beatDistribution, FxEventBox.defaultValue.beatDistribution);
   obj.beatDistributionType = fixInt(
      obj.beatDistributionType,
      FxEventBox.defaultValue.beatDistributionType,
      [1, 2],
   );
   obj.fxDistribution = fixFloat(obj.fxDistribution, FxEventBox.defaultValue.fxDistribution);
...
function _fixFxEventInt(obj: FxEventInt): void {
   ...
   obj.previous = fixInt(obj.previous, FxEventInt.defaultValue.previous, [0, 1]);
...
function fixFxEventFloat(obj: IWrapFxEventFloatAttribute): void {
   ...
   obj.previous = fixInt(obj.previous, FxEventFloat.defaultValue.previous, [0, 1]);
